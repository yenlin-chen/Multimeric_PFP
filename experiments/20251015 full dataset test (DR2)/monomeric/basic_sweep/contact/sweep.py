...
sweep_config = {
    'name': f'basic_sweep-{dataset_version}-multimeric-contact',
    'method': 'bayes',
    'metric': {
    ...
    'parameters': {
        ...
        'edge_types_to_use': {'values': [['contact']]},
        'edge_policy': {'values': ['1CONT']},
        'use_monomers': {'values': [True]},
        ...
        'graph_global_pool': {'values': ['max']}, # 'mean'
        ...
        'n_fc_hidden_layers': {'values': [2, 3]}, # {'min': 1, 'max': 5},
